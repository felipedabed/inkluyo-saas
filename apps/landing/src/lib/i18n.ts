...
export interface Translations {
  ...
  home: {
    ...
    demoTeaserTitle: string;
    demoTeaserDesc: string;
    demoTeaserCta: string;
  };
  landing: {
    sufrimometro: string;
    heroEyebrow: string;
    ...
    ctaInstall: string;
    ctaInstallShouting: string;
    ctaGetIt: string;
    ctaUnderstood: string;
    ...
    sectionRecursive: string;
    recursiveBefore: string;
    recursiveAfter: string;
    quoteHeadline: string;
    quotes: { author: string; role: string; body: string }[];
  ...
  playground: {
    title: string;
    subtitle: string;
    columns: { config: string; preview: string };
    config: {
      color: string;
      position: string;
      lang: string;
  ...
  dashboard: {
    ...
    recent: { headline: string; columns: string[] };
    cta: string;
  };
  common: {
    backHome: string;
...
const en: Translations = {
  ...
  home: {
    ...
    features: [
      { title: "Dyslexia Friendly", desc: "Instantly swap your fonts to dyslexic-friendly typefaces." },
      { title: "High Contrast", desc: "Smart inversion of colors so text is always readable." },
      { title: "Calm Mode", desc: "Pause all animations and transitions with one click." }
    ],
  ...
  landing: {
    ...
    heroClarity:
      "Inkluyo is a widget you install with one line of <script>. It lets your visitors adapt your site to their needs — dyslexia, low vision, reduced mobility and more — without you touching a single component.",
    heroSubtitle:
      "We built this page terribly so you can feel what 1 in 4 web users feels every day. The little floating button on the right? That's the widget. Click it. Watch this nightmare turn human.",
    ...
    statsSubhead:
      "These numbers are real. Your site is probably part of them.",
    stats: [
      { value: "98%", label: "of websites have at least one WCAG failure" },
      { value: "$13B", label: "in global accessibility lawsuits since 2018" },
      { value: "1.3B", label: "people worldwide live with a disability" },
      { value: "30s", label: "average time to install Inkluyo" },
    ],
    ...
    snippetSubtitle:
      "Drop this in your <head>. Done. Want custom colors? See pricing.",
    snippetCopy: "Copy snippet",
    snippetCopied: "Copied ✓",
    finalCta: "OK, I'm ready. Make my site accessible.",
    finalCtaSubtitle:
      "30-second install. Cancel anytime. Free tier forever, no card.",
    ...
    popup: {
      ...
      annoyance:
        "(closing this is futile — that's the point of intrusive popups)",
    },
    cookies: {
      body:
        "We use cookies to track you across the internet, sell your data, and pretend it's all about \"better experiences\". By staying you agree to ALL of it (yes, really).",
    ...
    footer: {
      ...
      microSecret:
        "If you read this without help, hire a designer. 🫡",
    },
  },
  pricing: {
    eyebrow: "Pricing",
    ...
    subtitle:
      "No tricks. No usage caps. The widget is the product, not a teaser.",
    monthly: "Monthly",
    yearly: "Yearly",
  ...
  getStarted: {
    ...
    subtitle:
      "Configure your widget. We'll build the exact <script> tag for you to paste in your <head>.",
    field: {
      domain: "Your website",
    ...
    snippetCopied: "Copied ✓",
    snippetHelp:
      "Paste this just before </head>. The widget appears within seconds.",
    successTitle: "You're ready",
    successBody:
      "After pasting the snippet, the floating button will appear on every page of your site. No further setup.",
  },
  playground: {
    title: "Widget playground",
    subtitle:
      "Tweak everything. The widget on this page reflects your config in real time.",
    columns: { config: "Configuration", preview: "Live preview" },
    config: {
      color: "Primary color",
      position: "Position",
      lang: "Default language",
    ...
    preview: {
      tip:
        "The widget is mounted on this page. Open it bottom-right to see your config live.",
    },
    exportTitle: "Export this configuration",
    exportHelp:
      "Drop this <script> tag in your site's <head>. Done.",
    saveAndContinue: "Save config & get install snippet",
  },
  dashboard: {
    title: "Your accessibility dashboard",
    subtitle:
      "Real-time analytics on how your visitors use Inkluyo. (Mockup — coming in our beta)",
    mockBanner:
      "🛠 Preview — these numbers are illustrative and update on every page load.",
    metrics: {
    ...
    recent: {
      ...
      columns: ["Time", "Page", "Feature", "Country"],
    },
...
const es: Translations = {
  ...
  home: {
    ...
    features: [
      { title: "Modo Dislexia", desc: "Cambia instantáneamente tus fuentes a tipografías aptas para dislexia." },
      { title: "Alto Contraste", desc: "Inversión inteligente de colores para que el texto siempre sea legible." },
      { title: "Modo Calma", desc: "Pausa todas las animaciones y transiciones con un solo clic." }
    ],
  ...
  landing: {
    ...
    heroClarity:
      "Inkluyo es un widget que se instala con una línea de <script>. Permite a tus visitantes adaptar tu sitio a sus necesidades — dislexia, baja visión, motricidad reducida y más — sin que toques un solo componente.",
    heroSubtitle:
      "Hicimos esta página terrible para que sientas lo que 1 de cada 4 usuarios web siente cada día. ¿El botón flotante de la derecha? Ese es el widget. Hazle click. Mira cómo este desastre se vuelve humano.",
    ...
    statsSubhead:
      "Son cifras reales. Probablemente tu sitio sea parte de ellas.",
    stats: [
      { value: "98%", label: "de los sitios web tienen al menos una falla WCAG" },
      { value: "$13B", label: "en demandas globales de accesibilidad desde 2018" },
      { value: "1.3B", label: "personas en el mundo viven con alguna discapacidad" },
      { value: "30s", label: "promedio para instalar Inkluyo" },
    ],
    ...
    snippetSubtitle:
      "Pega esto en tu <head>. Listo. ¿Quieres colores custom? Mira los precios.",
    snippetCopy: "Copiar snippet",
    snippetCopied: "Copiado ✓",
    finalCta: "OK, listo. Hagan mi sitio accesible.",
    finalCtaSubtitle:
      "Instalación en 30 segundos. Cancela cuando quieras. Plan free para siempre, sin tarjeta.",
    ...
    popup: {
      ...
      annoyance:
        "(cerrar esto es inútil — esa es la idea de los popups intrusivos)",
    },
    cookies: {
      body:
        "Usamos cookies para rastrearte por todo internet, vender tus datos, y fingir que es \"para mejorar tu experiencia\". Si te quedas, aceptas TODO (sí, en serio).",
    ...
    footer: {
      ...
      microSecret:
        "Si leíste esto sin ayuda del widget, contrata diseñadores. 🫡",
    },
  },
  pricing: {
    eyebrow: "Precios",
    ...
    subtitle:
      "Sin trampas. Sin límites de uso. El widget es el producto, no un anzuelo.",
    monthly: "Mensual",
    yearly: "Anual",
  ...
  getStarted: {
    ...
    subtitle:
      "Configura tu widget. Te armamos el <script> exacto para que lo pegues en tu <head>.",
    field: {
      domain: "Tu sitio web",
    ...
    snippetCopied: "Copiado ✓",
    snippetHelp:
      "Pega esto justo antes de </head>. El widget aparece en segundos.",
    successTitle: "Listo",
    successBody:
      "Después de pegar el snippet, el botón flotante aparece en cada página de tu sitio. Sin más configuración.",
  },
  playground: {
    title: "Playground del widget",
    subtitle:
      "Toca todo. El widget de esta página refleja tu config en tiempo real.",
    columns: { config: "Configuración", preview: "Vista previa" },
    config: {
      color: "Color primario",
      position: "Posición",
      lang: "Idioma por defecto",
    ...
    preview: {
      tip:
        "El widget está montado en esta página. Ábrelo abajo a la derecha para ver tu config en vivo.",
    },
    exportTitle: "Exportar esta configuración",
    exportHelp:
      "Pega este <script> en el <head> de tu sitio. Listo.",
    saveAndContinue: "Guardar config y obtener snippet",
  },
  dashboard: {
    title: "Tu dashboard de accesibilidad",
    subtitle:
      "Analytics en tiempo real de cómo tus visitantes usan Inkluyo. (Mockup — viene en nuestra beta)",
    mockBanner:
      "🛠 Vista previa — los números son ilustrativos y se regeneran en cada carga.",
    metrics: {
    ...
    recent: {
      ...
      columns: ["Hora", "Página", "Feature", "País"],
    },
...
const pt: Translations = {
  ...
  home: {
    ...
    features: [
      { title: "Amigável para Dislexia", desc: "Troque fontes instantaneamente por tipografias para dislexia." },
      { title: "Alto Contraste", desc: "Inversão inteligente de cores para leitura sempre clara." },
      { title: "Modo Calma", desc: "Pause todas as animações e transições com um clique." }
    ],
  ...
  landing: {
    ...
    heroClarity:
      "Inkluyo é um widget que você instala com uma linha de <script> ou um plugin. Ele permite que seus visitantes adaptem seu site às necessidades deles — dislexia, baixa visão, mobilidade reduzida e mais — sem você tocar em um único componente.",
    heroSubtitle:
      "Fizemos esta página terrível para que você sinta o que 1 em cada 4 usuários web sente todos os dias. O pequeno botão flutuante à direita? Esse é o widget. Clique nele. Veja este pesadelo se tornar humano.",
    ...
    stats: [
      { value: "98%", label: "dos sites têm pelo menos uma falha WCAG" },
      { value: "$13B", label: "em processos globais de acessibilidade desde 2018" },
      { value: "1.3B", label: "pessoas no mundo vivem com uma deficiência" },
      { value: "30s", label: "tempo médio para instalar o Inkluyo" },
    ],
  ...
  playground: {
    ...
    columns: { config: "Configuração", preview: "Prévia ao vivo" },
    config: {
      color: "Cor primária",
      position: "Posição",
      lang: "Idioma padrão",
  ...
  dashboard: {
    ...
    recent: {
      ...
      columns: ["Hora", "Página", "Recurso", "País"],
    },
...
const DICTS: Record<Lang, Translations> = { en, es, pt };
