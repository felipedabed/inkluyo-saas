...
interface Props {
  lang: Lang;
  t: Translations["home"];
  tLanding: Translations["landing"];
}

export function HomePageClient({ lang, t, tLanding }: Props) {
  const [showContactModal, setShowContactModal] = useState(false);

  const certificationContent = {
    en: {
      title: "Accessibility Certification",
      subtitle: "WCAG Compliance & Standards",
      desc: "Our widget allows you to certify the accessibility levels AA and AAA of your websites, in accordance with international standards and reference guidelines:",
      standards: [
        "UNE-EN 301549 - ICT Accessibility Requirements",
        "WCAG 2.1 Guidelines - Web Content Accessibility",
        "WAI Initiative - Web Accessibility Standards",
      ],
      features: [
        "Certify compliance with AA level accessibility (legally required)",
        "Support for AAA level certification for maximum accessibility",
        "Technical accessibility audit of your website",
        "Identification of compliance issues and remediation plan",
        "Post-correction verification and monitoring",
        "Applicable to all web content types",
      ],
    },
    es: {
      title: "Certificación de Accesibilidad",
      subtitle: "Cumplimiento WCAG y Estándares",
      desc: "Nuestro widget te permite certificar los niveles de accesibilidad AA y AAA de tus sitios web, conforme a las normas y estándares de referencia:",
      standards: [
      ...
      features: [
        "Certifica el cumplimiento del nivel AA de accesibilidad (requerido por ley)",
        "Soporte para certificación de nivel AAA para máxima accesibilidad",
        "Evaluación técnica de accesibilidad de tu sitio web",
        "Identificación de incumplimientos y plan de acciones",
        "Verificación posterior de las correcciones realizadas",
        "Se aplica a cualquier tipo de contenido web",
      ],
    },
    pt: {
      title: "Certificação de Acessibilidade",
      subtitle: "Conformidade WCAG e Padrões",
      desc: "Nosso widget permite certificar os níveis de acessibilidade AA e AAA de seus sites, em conformidade com normas e diretrizes de referência:",
      standards: [
        "UNE-EN 301549 - Requisitos de Acessibilidade para Produtos e Serviços TIC",
        "WCAG 2.1 - Diretrizes de Acessibilidade para Conteúdo Web",
        "WAI - Iniciativa de Acessibilidade Web",
      ],
      features: [
        "Certifique a conformidade com o nível AA de acessibilidade (exigido por lei)",
        "Suporte para certificação de nível AAA para máxima acessibilidade",
        "Auditoria técnica de acessibilidade do seu site",
        "Identificação de não conformidades e plano de ações",
        "Verificação posterior das correções realizadas",
        "Aplicável a qualquer tipo de conteúdo web",
      ],
    },
  };

  const cert = certificationContent[lang];
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto max-w-3xl mb-16">
              <h3 className="text-lg font-semibold text-slate-900 mb-6">
                {lang === "es" ? "Normas y Estándares" : lang === "pt" ? "Normas e Padrões" : "Standards & Compliance"}
              </h3>
              <ul className="space-y-3">
                {cert.standards.map((standard, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <span className="mt-1 flex-shrink-0 w-1.5 h-1.5 rounded-full bg-indigo-600" />
            ...
            <div className="mx-auto max-w-3xl">
              <h3 className="text-lg font-semibold text-slate-900 mb-6">
                {lang === "es" ? "Lo que incluye" : lang === "pt" ? "O que está incluído" : "What's Included"}
              </h3>
              <ul className="grid grid-cols-1 gap-4">
                {cert.features.map((feature, i) => (
                  <li key={i} className="flex items-start gap-3 bg-white p-4 rounded-lg border border-slate-200">
                    <svg className="mt-0.5 flex-shrink-0 w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
